...
class Selftest extends Controller {
	...
	public function test_8() {
		$fail = 0;
		$files = array('tmp_name' => getcwd () . '/uploads/ria1.jpg', 'name' => 'test.jpg', 'size' => filesize(getcwd() . '/uploads/ria1.jpg'), 'error' => 0, 'type' => 'image/jpeg');

		if(!file_exists(getcwd() . '/uploads/ria1.jpg')) {
			$fail = 1;
			$this->errors[8] .= 'Essential ria imagery is missing (uploads/ria1.jpg). ';
		}
